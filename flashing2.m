...
cp=2.9982e-06*Tref^4-0.0012842*Tref^3+0.20861*Tref^2-15.355*Tref+1477.9;                                   
ktc=2.9923e-12*Tref^4-1.3097e-09*Tref^3+1.371e-07*Tref^2+9.6886e-05*Tref-0.00075523;   
mu=1.5049e-15*Tref^4-5.8632e-13*Tref^3+1.5584e-11*Tref^2+7.4642e-08*Tref-2.7166e-07;   
hb=-3.5918e-05*Tb^4+0.015703*Tb^3-2.6332*Tb^2+1243.4*Tb-6806.3;
hamb=-3.5918e-05*Tamb^4+0.015703*Tamb^3-2.6332*Tamb^2+1243.4*Tamb-6806.3;              
rho=9.5346e-09*Tamb^4-4.4002e-06*Tamb^3+0.00080687*Tamb^2-0.07331*Tamb+3.2837 ;       
Pr=(mu*cp)/ktc;                                                                       


% Reduction of superheat with intial delta T = 29 K assuming delta T reduces 1K every time step%
...
% Guess for a good initial values for the Bisection method%
%xl=0.15e-19;   %upper guess%    % change it according to the boundary conditions  %very important%
%xu=0.25e-10;   %lower guess%    % change it according to the boundary condtions  % %very important%
...
% Bisection method for finding the initial valure for fixed point iteration% % checked%
